...
public class VoiceMail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String mail = To.getText().toString();
        ...
        startActivity(Intent.createChooser(intent,"Choose an Sending option"));
        ...
        private void listen(){
            ...
            try {
                ...
                Toast.makeText(VoiceMail.this, "Your device doesn't support Speech Recognition", Toast.LENGTH_SHORT).show();
            }
        }
